...
export default function ActivityDetail() {
  ...
  const stats = [
    ...
    ...(isRide ? [{ label: "Avg Power", value: activity.device_watts && activity.average_watts ? `${Math.round(activity.average_watts)}W` : "—", icon: Zap }] : []),
    ...(isRide ? [{ label: "NP", value: activity.device_watts && np !== null ? `${np}W` : "—", icon: Zap }] : []),
